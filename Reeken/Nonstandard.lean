...
This entry point imports the generic NSA development without the polygon geometry or
the Jordan curve theorem. The model, hypotheses, and transfer boundary are documented in
`docs/nonstandard-tooling.md`.
-/
