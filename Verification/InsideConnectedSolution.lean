...
/-- The common boundaries and inside connectivity for every continuous circle embedding. -/
theorem curve_inside_connected
  ...
  refine ⟨standardInside p, standardOutside p, standardInside_nonempty p hmax hs,
    standardOutside_nonempty p, isPathConnected_standardInside p hmax hs, isOpen_standardInside p, isOpen_standardOutside p,
