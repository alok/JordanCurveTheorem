...
/-- The common boundaries and connectivity of both regions for every continuous circle embedding. -/
theorem curve_complement_connected
  ...
  refine ⟨standardInside p, standardOutside p, standardInside_nonempty p hmax hs,
    standardOutside_nonempty p, isPathConnected_standardInside p hmax hs,
    isPathConnected_standardOutside p hmax hs, isOpen_standardInside p, isOpen_standardOutside p,
